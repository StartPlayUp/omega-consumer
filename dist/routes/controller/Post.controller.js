...
exports.getLikeIt = exports.likeIt = exports.sendPost = void 0;
...
var sendPost = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, title, content, ipAddress, userUuid, result;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, title = _a.title, content = _a.content, ipAddress = _a.ipAddress, userUuid = _a.userUuid;
                console.log(title);
...
var likeIt = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, postUuid, userUuid, likeIt, result;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, postUuid = _a.postUuid, userUuid = _a.userUuid, likeIt = _a.likeIt;
