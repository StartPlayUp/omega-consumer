...
var Comment = /** @class */ (function (_super) {
    ...
    Comment.prototype.toJSON = function () {
        if (this.deleted) {
            return __assign(__assign({}, this), { content: "삭제된 글 입니다", password: undefined, test: this.user_nickname });
        }
        else {
            return __assign(__assign({}, this), { test: this.user_nickname, password: undefined });
        }
    };
    var Comment_1;
    __decorate([
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return User_1.User; }, function (user) { return user.commentsForNickname; }, {
            onDelete: "CASCADE",
            onUpdate: "CASCADE"
        }),
        (0, typeorm_1.JoinColumn)({ name: 'user_nickname', referencedColumnName: 'nickname' }),
        __metadata("design:type", User_1.User)
    ], Comment.prototype, "user_nickname", void 0);
    __decorate([
